...
def get_args():
    ...
    parser.add_argument('-num_block', type=int, default=10000000)
    ...
    parser.add_argument('-snr_test_start', type=float, default=2.0)
    parser.add_argument('-snr_test_end', type=float, default=4.0)
    parser.add_argument('-snr_points', type=int, default=5)
